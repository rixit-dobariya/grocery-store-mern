...
const { getAboutPageService, updateAboutPageService } = require("../services/about-page.service");
...
const updateAboutPage = asyncHandler(async (req, res) => {
    ...
    res.status(isNew ? 201 : 200).json({
        success: true,
        message: isNew ? "About page created successfully" : "About page updated successfully",
        data: aboutPage,
    });
});
