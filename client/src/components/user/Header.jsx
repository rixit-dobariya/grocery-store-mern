                ...
                <nav id="navibar" className="navbar navbar-expand-lg navbar-light sticky-top container-fluid">
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                            <Link className="logo navbar-brand fs-1 fw-bold" style={{ color: "#198754" }} to="/">
                                PureBite
                            </Link>
                            ...
                            <div className="d-flex justify-content-end align-items-center flex-sm-row flex-column">
                                <div className="d-flex justify-content-end align-items-center not-hidden" id="SearchSection2">
                                    <form className="d-flex justify-content-end" onSubmit={validateSearch}>
                                        <input
                                ...
                                <div className="d-flex justify-content-between align-items-center justify-content-sm-between w-100">
                                    <li className="nav-item dropdown profile-menu ms-lg-auto">
                                        ...
                                        <ul id="pro-drop" className="dropdown-menu dropdown-menu-dark">
                                            <li>
                    ...
                    <div className="container">
                        ...
                        <div className="collapse navbar-collapse justify-content-between" id="navbarTogglerDemo01">
                            ...
                            <form className="d-flex flex-nowrap justify-content-end">
                                <input className="search-input" type="search" placeholder="Search for items..." size="25" />
                                <button className="primary-btn me-3 search-button">
                                    <i className="fa fa-search" aria-hidden="true"></i>
                                </button>
